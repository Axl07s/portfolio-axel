    ...
    <article className="min-h-screen bg-[#f4f4f5] text-zinc-950 font-sans selection:bg-[#ff4400] selection:text-white">
      ...
      >
         ...
         >
            ...
            {/* Tablet - Middle layer */}
            <div 
              className="absolute top-[35%] left-[5%] w-[50%] md:w-[40%] aspect-[4/3] bg-zinc-800 border-4 border-zinc-950 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.9)] overflow-hidden z-20 transition-transform duration-500"
              style={{ transform: 'translateZ(50px) rotate(3deg)' }}
            >
               <img src={project.images[1]?.url} alt="Tablet" className="w-full h-full object-cover object-center opacity-80 hover:opacity-100 transition-opacity" />
            </div>

            {/* Phone - Foreground layer */}
            <div 
              className="absolute bottom-[5%] left-[55%] md:left-[40%] w-[30%] md:w-[20%] aspect-[9/19.5] bg-zinc-950 border-[10px] border-zinc-800 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.9)] overflow-hidden z-30 transition-transform duration-500"
            ...
            >
               ...
               <img src={project.images[2]?.url} alt="Phone" className="w-full h-full object-cover object-top" />
               <div 
