    ...
    <article className="min-h-screen bg-[#faf9f6] text-[#1a1a1a] font-sans selection:bg-indigo-500/30 overflow-hidden">
      ...
      >
         ...
         >
            ...
            <div 
               className="absolute w-[240px] md:w-[280px] aspect-[9/19.5] bg-white rounded-[2.5rem] border-[12px] border-zinc-200 shadow-2xl overflow-hidden transition-transform duration-700 ease-out"
            ...
            <div 
               className="absolute w-[260px] md:w-[320px] aspect-[9/19.5] bg-white rounded-[3rem] border-[14px] border-zinc-900 shadow-[0_50px_100px_rgba(0,0,0,0.15)] overflow-hidden transition-transform duration-700 ease-out"
